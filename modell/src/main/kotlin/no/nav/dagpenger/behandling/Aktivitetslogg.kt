...
import no.nav.dagpenger.behandling.Aktivitetslogg.Aktivitet.Behov
import no.nav.dagpenger.behandling.Aktivitetslogg.Aktivitet.Behov.Behovtype
...
class Aktivitetslogg private constructor(
    ...
    companion object {
        ...
        private val MODELL_KONTEKSTER = listOf(Person.kontekstType, NyRettighetsbehandling.kontekstType)
        fun rehyder(
    ...
    override fun kontekst(behandling: NyRettighetsbehandling) {
...
interface IAktivitetslogg {
    ...
    fun kontekst(behandling: NyRettighetsbehandling)
