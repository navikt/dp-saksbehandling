...
data class Oppgave private constructor(
    ...
    fun ferdigstill(innsendingFerdigstiltHendelse: InnsendingFerdigstiltHendelse): Handling =
    ...
    object KlarTilBehandling : Tilstand {
        ...
        override fun avbryt(
            ...
            oppgave.endreTilstand(Avbrutt, behandlingOpprettetForSøknadHendelse)
        }
    }
    ...
    sealed interface Tilstand {
        ...
        fun avbryt(
            ...
            ulovligTilstandsendring(
                ...
                message =
                    "Kan ikke avbryte oppgave i tilstand $type for " +
                        "${behandlingOpprettetForSøknadHendelse.javaClass.simpleName}",
            )
        }
