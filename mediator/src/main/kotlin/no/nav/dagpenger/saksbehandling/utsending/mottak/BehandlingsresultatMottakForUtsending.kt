...
internal class BehandlingsresultatMottakForUtsending(
    ...
    override fun requiredBehandletHendelseType(): List<String> = listOf("Søknad", "Manuell", "Meldekort", "Omgjøring", "Ferietillegg")
    ...
    override fun håndter(
        ...
        if (skalStarteUtsending) {
            ...
            val skipSetBehandlingId = setOf<UUID>(UUID.fromString("019c47bb-bf42-78e8-b695-19474094c704"))
