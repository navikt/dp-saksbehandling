...
import no.nav.dagpenger.saksbehandling.api.tilgangskontroll.KathrineTilgangskontroll
            ...
            route("oppgave") {
                ...
                route("{oppgaveId}") {
                    ...
                    route("ferdigstill/melding-om-vedtak") {
                        put {
                            oppgaveTilgangskontroll(tilgangskontroller + KathrineTilgangskontroll)
