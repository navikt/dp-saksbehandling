...
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.AvslagÅrsak.AVSLAG_ALDER
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.AvslagÅrsak.AVSLAG_ANDRE_YTELSER
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.AvslagÅrsak.AVSLAG_ARBEIDSINNTEKT
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.AvslagÅrsak.AVSLAG_ARBEIDSTID
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.AvslagÅrsak.AVSLAG_IKKE_REGISTRERT
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.AvslagÅrsak.AVSLAG_MEDLEMSKAP
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.AvslagÅrsak.AVSLAG_MINSTEINNTEKT
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.AvslagÅrsak.AVSLAG_OPPHOLD_UTLAND
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.AvslagÅrsak.AVSLAG_REELL_ARBEIDSSØKER
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.AvslagÅrsak.AVSLAG_STREIK
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.AvslagÅrsak.AVSLAG_UTDANNING
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.AvslagÅrsak.AVSLAG_UTESTENGT
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.Rettighet.RETTIGHET_KONKURS
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.Rettighet.RETTIGHET_ORDINÆR
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.Rettighet.RETTIGHET_PERMITTERT
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.Rettighet.RETTIGHET_PERMITTERT_FISK
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.Rettighet.RETTIGHET_VERNEPLIKT
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.Utfall.AVSLAG
import no.nav.dagpenger.saksbehandling.RegelmotorEmneknagger.Utfall.INNVILGELSE
