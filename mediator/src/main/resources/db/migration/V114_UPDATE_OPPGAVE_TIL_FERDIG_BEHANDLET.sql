-- Pga timeout mot regelmotor har enkele oppgaver kommet ut av synk med regelmotor. En av oppgavene har fått sendt ut vedtaksbrev, den andre ikke.
UPDATE oppgave_v1
SET    tilstand = 'FERDIG_BEHANDLET'
WHERE  tilstand = 'UNDER_BEHANDLING'
AND    id IN('019e0248-ce30-77fc-aba7-25bee05d5c06','019e0405-9e2e-74ac-aa6e-a8ef1b537ca5');
