...
class SøkefilterTest {
    ...
    fun `Skal kunne initialisere et søkefilter fra Ktor sin QueryParameters`() {
        Parameters.build {
            ...
            Søkefilter.fra(it) shouldBe Søkefilter(
    ...
    @Test
    fun `Bruk default verdier dersom query parameters ikke inneholder tilstand, fom eller tom`() {
        Søkefilter.fra(Parameters.Empty) shouldBe Søkefilter.DEFAULT_SØKEFILTER
    }
