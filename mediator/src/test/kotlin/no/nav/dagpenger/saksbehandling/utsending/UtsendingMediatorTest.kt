...
class UtsendingMediatorTest {
        ...
        DBTestHelper.withBehandling(behandling = behandling, person = person) { ds ->
            ...
            rapid.inspektør.message(1).toString() shouldEqualSpecifiedJson
                ...
                """
                {
                  ...
                  "tittel" : "${UtsendingType.VEDTAK_DAGPENGER.brevTittel}",
                  "skjemaKode" : "${UtsendingType.VEDTAK_DAGPENGER.skjemaKode}",
                  "ident": "${person.ident}",
                  "pdfUrn": "$pdfUrnString",
                  "sak": {
                    "id": "${utsendingSak.id}",
    ...
    @Test
    fun `Livssyklus for en utsending med brev ved avvist klage`() {
        val behandling =
            Behandling(
                behandlingId = UUIDv7.ny(),
                utløstAv = HendelseBehandler.Intern.Klage,
        ...
        DBTestHelper.withBehandling(behandling = behandling, person = person) { ds ->
            ...
            utsendingMediator.opprettUtsending(
                ...
                brev = htmlBrev,
                ident = person.ident,
                type = UtsendingType.KLAGE_AVVIST,
            )
            ...
            rapid.inspektør.message(1).toString() shouldEqualSpecifiedJson
                ...
                """
                {
                  ...
                  "tittel" : "${UtsendingType.KLAGE_AVVIST.brevTittel}",
                  "skjemaKode" : "${UtsendingType.KLAGE_AVVIST.skjemaKode}",
                  "ident": "${person.ident}",
                  "pdfUrn": "$pdfUrnString",
                  "sak": {
                    "id": "${utsendingSak.id}",
