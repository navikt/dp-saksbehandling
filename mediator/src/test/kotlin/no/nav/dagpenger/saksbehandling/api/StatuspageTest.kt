...
import no.nav.dagpenger.saksbehandling.RettTilDagpengerOppgave.RettTilDagpengerTilstand.ManglendeBeslutterTilgang
    ...
    fun `Error håndtering av UgyldigTilstandException`() {
        testApplication {
            ...
            application {
                ...
                routing {
                    get(path) { throw RettTilDagpengerTilstand.UgyldigTilstandException(message) }
                }
            }
    ...
    fun `Error håndtering av UlovligTilstandsendringException`() {
        testApplication {
            ...
            application {
                ...
                routing {
                    get(path) { throw Oppgave.Tilstand.UlovligTilstandsendringException(message) }
                }
            }
