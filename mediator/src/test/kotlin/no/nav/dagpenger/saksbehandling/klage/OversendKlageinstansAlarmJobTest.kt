    ...
    fun senderUtAlert() {
        runBlocking {
            ...
            testRapid.inspektør.message(0).let { jsonNode ->
                jsonNode["alertType"].asString() shouldBe "OVERSEND_KLAGEINSTANS_IKKE_FULLFØRT"
                jsonNode["@event_name"].asString() shouldBe "saksbehandling_alert"
                jsonNode["feilMelding"].asString() shouldBe "Oversendelse til klageinstans ikke fullført for " +
