...
class OppgaveFristUtgåttJobTest {
    ...
    fun `Sett utgåtte oppgaver klare igjen`() {
        val behandling1 = lagRettTilDPBehandling(utløstAvType = SØKNAD)
        val behandling2 = lagRettTilDPBehandling(utløstAvType = SØKNAD)
        val behandling3 = lagRettTilDPBehandling(utløstAvType = KLAGE)
        val behandling4 = lagRettTilDPBehandling(utløstAvType = KLAGE)
