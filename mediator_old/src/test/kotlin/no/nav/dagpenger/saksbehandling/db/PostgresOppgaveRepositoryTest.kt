...
import no.nav.dagpenger.saksbehandling.Behandling.TilstandType.TilBehandling
...
import no.nav.dagpenger.saksbehandling.Meldingsfabrikk.testSak
import no.nav.dagpenger.saksbehandling.Meldingsfabrikk.testSøknadUUID
...
import no.nav.dagpenger.saksbehandling.db.PostgresOppgaveRepositoryTest.TestData.enBoolean
import no.nav.dagpenger.saksbehandling.db.PostgresOppgaveRepositoryTest.TestData.enDato
import no.nav.dagpenger.saksbehandling.db.PostgresOppgaveRepositoryTest.TestData.enString
import no.nav.dagpenger.saksbehandling.db.PostgresOppgaveRepositoryTest.TestData.etDesimaltall
import no.nav.dagpenger.saksbehandling.db.PostgresOppgaveRepositoryTest.TestData.etHeltall
import no.nav.dagpenger.saksbehandling.db.PostgresOppgaveRepositoryTest.TestData.fastsettelseA
import no.nav.dagpenger.saksbehandling.db.PostgresOppgaveRepositoryTest.TestData.fastsettelseB
import no.nav.dagpenger.saksbehandling.db.PostgresOppgaveRepositoryTest.TestData.fastsettelseC
import no.nav.dagpenger.saksbehandling.db.PostgresOppgaveRepositoryTest.TestData.fastsettelseE
import no.nav.dagpenger.saksbehandling.db.PostgresOppgaveRepositoryTest.TestData.manuellSporing
import no.nav.dagpenger.saksbehandling.db.PostgresOppgaveRepositoryTest.TestData.quizSporing
import no.nav.dagpenger.saksbehandling.db.PostgresOppgaveRepositoryTest.TestData.søknadInnsendtHendelse
import no.nav.dagpenger.saksbehandling.db.PostgresOppgaveRepositoryTest.TestData.testBehandling
import no.nav.dagpenger.saksbehandling.db.PostgresOppgaveRepositoryTest.TestData.testOppgave
import no.nav.dagpenger.saksbehandling.db.PostgresOppgaveRepositoryTest.TestData.vedtakStansetHendelse
import no.nav.dagpenger.saksbehandling.db.PostgresOppgaveRepositoryTest.TestData.vilkårF
...
class PostgresOppgaveRepositoryTest {
    ...
    @Test
    fun `hent oppgave med søknad uuid`() =
        withMigratedDb {
            PostgresRepository(dataSource).let { repository ->
                repository.lagrePerson(testPerson)
                shouldNotThrowAny {
